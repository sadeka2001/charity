            ...
            <div class="row">
                <div class="col-lg-9 sm-padding">
                    <div class="blog-items single-post row">
                        ...
                        <h4><i class="ti-calendar"></i><time datetime="January 01,2018"
                            class="post_date"> {{ \Carbon\Carbon::parse($event_detail->date)->format('M d, Y') }} & {{ \Carbon\Carbon::parse($event_detail->time)->format('h:i:s A') }}</time>
                    </h4>
                                ...
                                <li>
                                    ...
                                    <ul class="comments-list reply-list">
                                        <li>
                                            <!-- Avatar -->
                                            <div class="comment-avatar"> <img
                                                    src="{{ asset('assets/fronted/img/comment-2.jpg') }}" alt="comment">
                                            </div>
                                            <!-- Contenedor del Comentario -->
                                            <div class="comment-box">
                                                <div class="comment-head">
                                        ...
                                        <li>
                                            <!-- Avatar -->
                                            <div class="comment-avatar"> <img
                                                    src="{{ asset('asets/fronetd/img/comment-3.jpg') }}" alt="comment">
                                            </div>
                                            <!-- Contenedor del Comentario -->
                                            <div class="comment-box">
                                                <div class="comment-head">
