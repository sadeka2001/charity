            ...
            <div class="row">
                <div class="col-lg-9 sm-padding">
                    <div class="blog-items single-post row">
                        <img src="{{ asset($cause_detail->image) }}" alt="blog post">
                        <h2>{{ $cause_detail->title }}</h2>
                        {{-- <div class="meta-info">
                            <span>
                                ...
                                <li>
                                    <div class="comment-main-level">
                                        ...
                                        <div class="comment-avatar"> <img
                                                src="{{ asset('assets/fronted/img/comment-1.jpg') }}" alt="comment"> </div>
