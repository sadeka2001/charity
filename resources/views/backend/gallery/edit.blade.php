    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('gallery.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" rows="10" class="form-control editor" required>{{ $gallery->description ?? old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="image"
                                                data-default-file="{{ isset($gallery->image) ? asset($gallery->image) : '' }}"
