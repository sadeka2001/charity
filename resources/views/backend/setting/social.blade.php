            ...
            <div class="ibox-body">
                <div class="row">
                    ...
                    <div class="col-md-9 border">
                        ...
                        <form action="{{ route('social.update') }}" id="settingsFrom" autocomplete="off" role="form" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="linkedin" id="linkedin" class="form-control @error('linkedin') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="instragram" id="instragram" class="form-control @error('instragram') is-invalid @enderror"
