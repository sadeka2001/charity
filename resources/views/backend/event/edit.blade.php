    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('event.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="title">Event Title <strong class="text-danger">*</strong></label>
                                            <input type="text" name="title" id="title"
                                                value="{{ $event->title ?? old('title') }}" class="form-control" required>
                                            @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" rows="10" class="form-control editor" required>{{ $event->description ?? old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="image"
                                                data-default-file="{{ isset($event->image) ? asset($event->image) : '' }}"
