    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('brand.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="link">Logo <strong class="text-danger">*</strong></label>
                                            <input type="text" name="link" id="link"
                                                value="{{ $brand->link ?? old('link') }}" class="form-control" required>
                                            @error('link')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="logo" id="logo"
                                                data-default-file="{{ isset($brand->logo) ? asset($brand->logo) : '' }}"
