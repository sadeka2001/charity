    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('certified.create') }}" class="btn bg-primary text-white"><i class="fa fa-plus-circle"></i> Add
                    New</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table style="width: 100%;" id="example"
                            ...
                            <tbody>
                                @forelse ($certified as $key=>$certificate)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td width="10%">
                                            <img src="{{ asset($certificate->image) }}" width="100%" alt="thumbnail">
                                        </td>
                                        ...
                                        <td style="text-align: center" width="12%">
                                            <a href="{{ route('certified.edit', $certificate->id) }}"
                                                class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                            <form id="delete-form-{{ $certificate->id }}"
                                                action="{{ route('certified.destroy', $certificate->id) }}" method="POST"
