    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('recent_work.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="description">Description <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="description" id="description" rows="10" class="form-control editor" required>{{ $recent_work->description ?? old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="image"
                                                data-default-file="{{ isset($recent_work->image) ? asset($recent_work->image) : '' }}"
